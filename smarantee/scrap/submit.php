<?php 
	...
	$insert_query="INSERT INTO `ssp_landing` (`id`, `name`, `contact`, `email`,`city`, `Brand`,`create_date`, `modified_date`,`frmtype`,`post_date`) VALUES ('', '".$name."', '".$phone."', '".$email."','".$city."','".$Brand."', now(), '','".$frmtype."', now());";		
	...
	$msg .= "<tr><td width='35%' align='left' valign='top' style='padding-left:10px;'><font face=verdana size=2>Brand</font></td><td width='65%' align='left'><font face=verdana size=2>:&nbsp;&nbsp;$Brand </font></td></tr><tr><td height='5'></td></tr>";
