		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto;float: none; ">
		                    				<div class="fform1 frmfield">
		                    					<input type="button" value="Buy Now" name="submit1" style="font-size:24px; width:94%; height:38px; background:#fdc70d;" onClick="return validate1()"   >
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
	    	...
	    	<div class="container">
	    		<div class="row">
	    			<div class="col-sm-12 aftersales1">
						...
						<span class="horgange">@ ₹ 899/- </span><span class="hwhite"></span></center>
                       </div>
                 </div>
           </div>
        </section>
