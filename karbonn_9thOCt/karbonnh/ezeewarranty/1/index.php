		    	...
		    	<div class="row">
	    			<div class="col-sm-8">
		    			...
		    			<h3 class="text-center fw-b">अभी खरीदें</h3>
		    				...
		    				<!--<img src="images/TOP.jpg" class="img-responsive">-->		    				<div class="fform">
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto;float: none; ">
		                    				<div class="fform1 frmfield">
		                    					<center><input type="button" value="अभी खरीदें" style="font-size:24px; width:94%; height:38px; background:#eb1c22;" name="submit1" onClick="return validate()"  ></center>
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
