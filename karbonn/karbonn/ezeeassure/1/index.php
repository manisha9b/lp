	    ...
	    <section>
	    	<div class="wrapper container" id="section_bg" >
		    	<div class="row" style="background-color: #666666;">
					...
					<div class="col-md-8" style="padding-right: 0%; padding-left:0%;display:none;">
                ...
                <!--  <input type="text" class=" pull-right" id="datepicker" placeholder="Date of Purchase"> -->
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto; float:none; ">
		                    				<div class="frmfield">
		                    					<input type="button" value="Buy Now" style="font-size:24px; width:94%; height:38px; background:#18bcbb;" name="submit1" onClick="return validate()"  >
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
	    			...
	    			<div class="col-sm-8">
	    				<div>
		    				...
		    				<h4 class="text-center">
		    					    <i class="fa fa-phone" aria-hidden="true" style="color:#6fcddf"></i>&nbsp; Call us on 1800-120-2177<br/>Or</span><br> Give a Miss Call On <b>8291939913</b>
		    				</h4>
		    				<div class="fform" >
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto;float: none; ">
		                    				<div class="fform1 frmfield">
		                    					<input type="button" value="Buy Now" style="font-size:24px; width:94%; height:38px; background:#18bcbb;" name="submit1" onClick="return validate1()"   >
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
