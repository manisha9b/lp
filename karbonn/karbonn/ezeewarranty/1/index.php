	    ...
	    <section>
	    	<div class="wrapper container" id="section_bg" >
		    	<div class="row" style="background-color: #373131;">
					...
					<img src="images/ezee-warranty1.jpg" class="img-responsive"> 
					</div>
		    		<div id="dpfrm" class="col-sm-4" style="float:right;border-top: 1.32em solid #373131;padding-left: 1%;">
		    			<div class="formbg">
                ...
                <!--  <input type="text" class=" pull-right" id="datepicker" placeholder="Date of Purchase"> -->
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto; float:none; ">
		                    				<div class="frmfield">
		                    					<input type="button" value="Buy Now" name="submit1" name="submit1" style="font-size:24px; width:94%; height:38px; background:#eb1c22;" onClick="return validate()"  >
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto;float: none; ">
		                    				<div class="fform1 frmfield">
		                    					<input type="button" value="Buy Now" style="font-size:24px; width:94%; height:38px; background:#eb1c22;" name="submit1" onClick="return validate1()"   >
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
