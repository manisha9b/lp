		    			...
		    			<div class="formbg">
		    				...
		    				<div class="fform">
		    					<form name="DetailForm" id="DetailForm" method="post">
	                    			...
	                    			<div class="col-sm-6">
                          				<div class="frmfield">
                          					<input type="text" name="imei_no" maxlength="100" id="df_imei_no"  onKeyPress="return validData(event,'num')" value="" placeholder="IMEI No.*" />
                          				</div>
	                    			</div>
									<div class="row">	
									<div class="col-sm-12">
		                    		...
		                    		<div class="frmfield">
		                    			  <center>  <p style="font-weight:bold;">*Cash On Delivery Available</p></center>
		                    			    <div class="clear"></div>
		                    			    </div>
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto; float:none;">
		                    				<div class="frmfield">
		                    					<input type="button" value="Buy Now" style="font-size:24px; width:94%; height:38px; background:#eb1c22;" name="submit1" onClick="return validate()"  >
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
	    	...
	    	<div class="container">
	    		<div class="row">
	    			<div class="col-sm-12 aftersales1">
						...
						<span class="horgange">@ ₹ 449/- </span><span class="hwhite"></span></center>
                       </div>
                 </div>
           </div>
        </section>
