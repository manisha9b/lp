                ...
                <!--  <input type="text" class=" pull-right" id="datepicker" placeholder="Date of Purchase"> -->
							...
							<input type="hidden" name="verify_otp" value="1" />
								...
								<div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12"><div id="msg1"></div></div>
                                    <div class="col-sm-6">
		                    			<div class="frmfield">
	                          					<input type="button" value="Verify" name="submit_otp1" name="submit_otp1" style="font-size:24px; width:94%; height:38px; background:#fdc70d;" onClick="return validateOtp(1)"  >
	                          				</div>
		                    		</div>
