	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" cz-shortcut-listen="true" style="">
	    ...
	    <section>
	    	<div class="wrapper container" id="section_bg" >
		    	<div class="row" style="background-color: #373131;">
		    		<div class="col-md-8" style="padding-right: 0px; padding-left:0px;">
					<img src="images/ezee-warranty2.jpg" class="img-responsive"> 
					</div>
		    		<div id="dpfrm" class="col-sm-4" style="float:left; border-top: 1.32em solid #373131;padding-left: 1%;">
		    			<div class="formbg">
                ...
                <!--  <input type="text" class=" pull-right" id="datepicker" placeholder="Date of Purchase"> -->
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto; float:none; ">
		                    				<div class="frmfield">
		                    				<input type="button" value="अभी खरीदें" style="font-size:24px; width:94%; height:38px; background:#eb1c22;" name="submit1" onClick="return validate()"  ></center>
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
							...
							<input type="hidden" name="verify_otp" value="1" />
								...
								<div class="col-sm-8">
                                   ...
                                   <!-- <div class="col-sm-12"><div class="alert alert-msg alert-dismissible alert-info" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="fa fa-times"></i></button></div></div> -->
                                    ...
                                    <div class="col-sm-6">
		                    			<div class="frmfield">
	                          					<input type="button" value="Verify OTP" name="submit_otp1" name="submit_otp1" style="font-size:18px;  height:28px; background:#eb1c22;" onClick="return validateOtp(1)"  >
	                          				</div>
		                    		</div>
		                    		</div>
		    	...
		    	<div class="row">
		    		...
		    		<h3 class="text-center fw-b">अभी खरीदें</h3>
		    				<h4 class="text-center">
		    					    <i class="fa fa-phone" aria-hidden="true" style="color:#6fcddf"></i>&nbsp; Call us on 1800-120-2177<br> <span style="font-size:12px; text-align:center;">Or</span><br> Give a Miss Call On <b>8291939913</b><hr> Fill in the form
		    				</h4>
		    				<div class="fform" >
                ...
                <!--  <input type="text" class=" pull-right" id="datepicker" placeholder="Date of Purchase"> -->
		                    		...
		                    		<div>
		                    			<div class="col-sm-6" style="margin:0 auto;float: none; ">
		                    				...
		                    				<center><input type="button" value="अभी खरीदें" style="font-size:24px; width:94%; height:38px; background:#eb1c22;" name="submit1" onClick="return validate1()"  ></center>
		                    				</div>	
		                    			</div>
		                    			<div class="clear"></div>
		                    		</div>
							...
							<input type="hidden" name="verify_otp" value="1" />
								...
								<div class="col-sm-8">
                                   ...
                                   <!-- <div class="col-sm-12"><div class="alert alert-msg alert-dismissible alert-info" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="fa fa-times"></i></button></div></div> -->
                                    ...
                                    <div class="col-sm-6">
		                    			<div class="frmfield">
	                          					<input type="button" value="Verify OTP" name="submit_otp2" name="submit_otp2" style="font-size:18px;  height:28px; background:#eb1c22;" onClick="return validateOtp(2)"  >
	                          				</div>
		                    		</div>
		                    		</div>
	    	...
	    	<div class="container">
	    		<div class="row">
	    			...
	    			<!--	<h1 class="hblue text-center" style="color:#FFFFFF;">
	    				...
	    				<center>
	    				<img src="images/ezee-warrantyb1.png" class="img-responsive">
